...
async def filter(client, message):
        ...
        try:
            ...
            await client.send_message(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("🖥️ ᴊᴏɪɴ ᴍᴀɪɴ ᴄʜᴀɴɴᴇʟ 🖥️", url=invite_link.invite_link)
                        ]
                    ]
                ),
                parse_mode="markdown"
    ...
    if 2 < len(message.text) < 100:    
        btn = []
        search = message.text
        result_txt = f"Found {(len(results))} Results For Query: <code>{query}</code>"
        ...
        if files:
            ...
            await client.send_sticker(chat_id=message.from_user.id, sticker='CAACAgUAAx0CRR6maAABASrBYVanFuPIQzA_aSpfCHmxrVT73GUAAoQCAALgGAlXYp-MQ_7uDCAeBA')
            return
        ...
        if query.data.startswith("next"):
            ...
            buttons = [
                [
                    ...
                    InlineKeyboardButton('ʙᴀᴄᴋ ᴜᴘ ɢʀᴘ', url='t.me/Cinema_Beacon_Group1')
                ]
                ]
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        InlineKeyboardButton('⚡ᴍɪɴɴᴀʟʟ ᴍᴜʀᴀʟɪ⚡', url=f'https://t.me/joinchat/pPpMBpJp3qYwNjZl')
                    ]
                    ]
